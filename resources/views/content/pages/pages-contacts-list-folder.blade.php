...
<div class="offcanvas-header">
  ...
  <div class="mb-3">
            ...
            <div class="input-group input-group-merge">
              ...
              <input type="text" name="foldername" id="basic-icon-default-company" class="form-control" placeholder="dossier1" aria-label="folder" aria-describedby="basic-icon-default-company2" />
            </div>
          ...
          <div class="mb-3">
            ...
            <div class="input-group input-group-merge">
              <span id="basic-icon-default-message2" class="input-group-text"><i class="bx bx-comment"></i></span>
              <textarea name="folderDescription" id="basic-icon-default-message" class="form-control" placeholder="Hi, Do you have a moment to talk DSIT" aria-label="Hi, Do you have a moment to talk Joe?" aria-describedby="basic-icon-default-message2"></textarea>
            </div>
          </div>
          </div>
...
<div class="input-group input-group-merge">
   ...
   <tr><th>Id</th><th>Folder Name</th><th>description</th></tr> 
