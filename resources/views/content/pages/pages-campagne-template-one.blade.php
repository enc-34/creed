  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li>
               ...
               <button  class="btn btn-outline-success my-2 my-sm-0" type="submit" id="submit" disabled="disabled" ><a class="dropdown-item" href="{{ route('pages-campagne-template-two') }}">Continuer</a></button>
    ...
    <div class="card mb-4">
      ...
      <div class="p-3 mb-2 bg-light text-dark ">
       ...
       <div class="nav-align-top mb-4">
        <ul class="nav nav-tabs nav-fill" role="tablist">
         <li class="nav-item">
          <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-justified-home" aria-controls="navs-justified-home" aria-selected="true"><i class="bx bxs-briefcase-alt-2"></i>Marketing</button>
         </li>
         <li class="nav-item">
          <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-justified-profile" aria-controls="navs-justified-profile" aria-selected="false"><i class="bx bxs-bell"></i> Services</button>
         </li>
         <li class="nav-item">
          <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-justified-messages" aria-controls="navs-justified-messages" aria-selected="false"><i class="bx bxs-key"></i>Authentification</button>
         </li>
        </ul>
      ...
      <div class="card-body">
        <div class="p-3 mb-2 bg-light text-dark rounded">
            ...
            <input type="name" class="form-control" id="exampleFormControlInput1" placeholder="Entrez un nom à votre modele">
        </div>
      </div>
