...
<div class="row">
  <div class="col-md-12">
    <ul class="nav nav-pills flex-column flex-md-row mb-3">
      ...
      <li class="nav-item"><a class="nav-link active" href="javascript:void(0);" id="notfi-whatsapp"><i class="tf-icons bx bx-home"></i> Notifications<span class="badge rounded-pill badge-center h-px-20 w-px-20 bg-danger">3</span></a></li>
